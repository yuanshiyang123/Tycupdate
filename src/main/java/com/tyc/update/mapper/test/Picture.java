...
import com.tyc.update.utils.FileUtil;
...
public class Picture {
    ...
    public static String getAuth() {
        ...
        String clientId = "2a5f8a53b7d64810a5b771ee5c45afca";
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = "468526f21a474592a34b2ad451b05d6a";
    ...
    public static String form() {
        ...
        try {
            // 本地文件路径
            String filePath = "in/微信图片_20200918103918.jpg";
